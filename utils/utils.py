...
import pytesseract
import glob, shutil, operator, sys, argparse, math, cv2
from matplotlib import pyplot as plt
import json, os, re, imutils, torch
...
def lista_bbox(path):
  l_op,_=image_processing(path)
  l_ocr=lista_ocr(path)
  return l_op+l_ocr
